...
* **Components**:
  - **Rust Client Updater** ([updater.rs](file:///D:/rustdesk_src/rustdesk/src/updater.rs), [common.rs](file:///D:/rustdesk_src/rustdesk/src/common.rs), [flutter_ffi.rs](file:///D:/rustdesk_src/rustdesk/src/flutter_ffi.rs)): Performs version check queries, downloads update files (EXE/MSI), and launches elevated silent installer processes. If no custom API server is configured, it falls back to querying the GitHub Releases API of `klarnet2009/rustdesk`.
  ...
  - **Android Update Service** ([UpdateService.kt](file:///D:/rustdesk_src/rustdesk/flutter/android/app/src/main/kotlin/com/carriez/flutter_hbb/UpdateService.kt)): Queries the GitHub Releases API of `klarnet2009/rustdesk`, parses assets for ARM/universal APK matching, downloads packages, and invokes native package installation intents.
